                ...
                <div class="row">
                  <div class="col-sm-5 col-xs-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="job title, skill or company name" >
                    </div>
                  </div>
                  <div class="col-sm-5 col-xs-6">
                    <div class="form-group">
              ...
              <div class="modal-content">
                <form>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control"><option value="">Any amount</option><option value="1-11">Less than 1 year</option><option value="12-24">1-2 years</option><option value="25-60">3-5 years</option><option value="61-120">6-10 years</option><option value="121">More than 10 years</option></select>
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Degree</label>
                          <select class="form-control"><option value="">Any degree</option><option value="di">Diploma</option><option value="as">Associates</option><option value="ba">Bachelors</option><option value="ms">Masters</option><option value="doc">Doctorate</option></select>
                        </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success btn-theme">Find Resumes</button>
                  </div>
                </form>
              </div>
            </div>
          </div><!-- end modal Advanced search -->
                  ...
                  <div class="box-list">
                    ...
                    <div class="item">
                      <div class="row">
                        ...
                        <div class="col-md-11">
                          <h3 class="no-margin-top"><a href="resume_details.php" class="">Bryon Czoch  <i class="fa fa-link color-white-mute font-1x"></i></a></h3>
                          <h5><span class="color-black">Chicago, IL</span></h5>
                          <p>PHP Developer - <span class="color-white-mute">Barcode Giant </span> <br/>
                            Programmer/Analyst II -  <span class="color-white-mute">University of Chicago</span><br/>
                            Indiana University,  Bachelor</p>
                          <div>
                            <span class="color-white-mute">Updated: Feb 19</span> - 
                    ...
                    <div class="item">
                      <div class="row">
                        <div class="col-md-1 hidden-sm hidden-xs"><div class="img-item"><img src="./assets/theme/images/people/2.jpg" alt=""></div></div>
                        <div class="col-md-11">
                          <h3 class="no-margin-top"><a href="resume_details.php" class="">Kinjal Gavadiya <i class="fa fa-link color-white-mute font-1x"></i></a></h3>
                          <h5><span class="color-black">San Jose, CA</span> </h5>
                          <p>PHP Developer - <span class="color-white-mute">Barcode Giant </span> <br/>
                            Programmer/Analyst II -  <span class="color-white-mute">University of Chicago</span><br/>
                            Indiana University,  Bachelor</p>
                          <div>
                            <span class="color-white-mute">Updated: Feb 10</span> - 
                            <a href="#" class="btn btn-xs btn-theme btn-default">save resume</a> 
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="item">
                      <div class="row">
                        <div class="col-md-1 hidden-sm hidden-xs"><div class="img-item"><img src="./assets/theme/images/people/3.jpg" alt=""></div></div>
                        <div class="col-md-11">
                          <h3 class="no-margin-top"><a href="resume_details.php" class="">Shivakumar Gudimalla  <i class="fa fa-link color-white-mute font-1x"></i></a></h3>
                          <h5><span class="color-black">Conway, AR</span></h5>
                          <p>PHP Developer - <span class="color-white-mute">Barcode Giant </span> <br/>
                            Programmer/Analyst II -  <span class="color-white-mute">University of Chicago</span><br/>
                            Indiana University,  Bachelor</p>
                          <div>
                            <span class="color-white-mute">Updated: Feb 12</span> - 
                            <a href="#" class="btn btn-xs btn-theme btn-default">save resume</a> 
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="item">
                      <div class="row">
                        <div class="col-md-1 hidden-sm hidden-xs"><div class="img-item"><img src="./assets/theme/images/people/4.jpg" alt=""></div></div>
                        <div class="col-md-11">
                          <h3 class="no-margin-top"><a href="resume_details.php" class="">Dhaval Patel <i class="fa fa-link color-white-mute font-1x"></i></a></h3>
                          <h5><span class="color-black">Las Vegas, NV </span> </h5>
                          <p>PHP Developer - <span class="color-white-mute">Barcode Giant </span> <br/>
                            Programmer/Analyst II -  <span class="color-white-mute">University of Chicago</span><br/>
                            Indiana University,  Bachelor</p>
                          <div>
                            <span class="color-white-mute">Updated: Feb 22</span> - 
                            <a href="#" class="btn btn-xs btn-theme btn-default">save resume</a> 
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="item">
                      <div class="row">
                        <div class="col-md-1 hidden-sm hidden-xs"><div class="img-item"><img src="./assets/theme/images/people/5.jpg" alt=""></div></div>
                        <div class="col-md-11">
                          <h3 class="no-margin-top"><a href="resume_details.php" class="">Mike Zaloznyy <i class="fa fa-link color-white-mute font-1x"></i></a></h3>
                          <h5><span class="color-black">Raleigh, NC </span> </h5>
                          <p>PHP Developer - <span class="color-white-mute">Barcode Giant </span> <br/>
                            Programmer/Analyst II -  <span class="color-white-mute">University of Chicago</span><br/>
                            Indiana University,  Bachelor</p>
                          <div>
                            <span class="color-white-mute">Updated: Feb 1</span> - 
                            <a href="#" class="btn btn-xs btn-theme btn-default">save resume</a> 
                          </div>
                        </div>
                      </div>
